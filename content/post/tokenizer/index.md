...
实现代码见 [Github naive BPE](https://github.com/jiangyigithub/assignment1-basics/blob/main/cs336_basics/naive_bpe.py)
...
其具体实现见 [Github](https://github.com/jiangyigithub/assignment1-basics/blob/main/cs336_basics/efficient_bpe.py)
...
具体实现见 [Github wordpiece](https://github.com/jiangyigithub/assignment1-basics/blob/main/cs336_basics/word_piece.py) (基于[huggingface llm course](https://huggingface.co/learn/llm-course/chapter6/4?fw=pt))。 代码实现除了选择最优pair的方式不同之外，和BPE基本一致。
...
具体实现见 [Github wordpiece](https://github.com/jiangyigithub/assignment1-basics/blob/main/cs336_basics/unigram.py) (基于[huggingface llm course](https://huggingface.co/learn/llm-course/chapter6/4?fw=pt))。代码实现的关键在于为每个word选取最优分割，huggingface是采取了动态规划的方法，也就是我们使用 `dp[i]` 来表示 `word[:i]` 的最优score，这样我们有：
